...
export default function Navbar() {
  ...
  return (
    <div className="w-full flex flex-col items-center relative z-[999999999]">
        <div className={`w-[95%] duration-300 fixed ${scrollingUp ? 'top-5' : 'top-0'} bg-[rgba(255,255,255,.05)] backdrop-blur-md flex items-center justify-between px-8 py-3 border-[2px] border-[#192655] rounded-2xl`}>

...
export default function Footer() {
  return (
    <footer className="relative w-full bg-[linear-gradient(to_top,_#192655,_#01BAEF)] min-h-[100px] p-[20px_0_0] flex justify-center items-center flex-col mt-[200px]">
        <div className="waves">
        ...
        <div className="w-full p-[15px_20px] text-[0.9rem] text-center bg-[#192655]">
